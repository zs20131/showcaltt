    ...
    .directive("xnMultipleSelectTree", function() {
        return {
            ...
            link: function($scope, element, attrs, ngModel, fn) {
                ...
                //查找子节点
                $scope.getChild = function($scope, pid, dataList, level, isSelected, isPush, isShow){
                    level ++;
                    angular.forEach(dataList, function(data){
                        if(data.parentId === pid){
                            ...
                            $scope.getChild($scope, data.id, dataList, level, isSelected, isPush, isShow);
                        }
                    });
                };
                    ...
                    if($scope.selectData.length>0){
                        angular.forEach($scope.selectData,function(data){
                            if(data.parentId == null){
                                ...
                                $scope.selectedDataList.push(data);
                                $scope.getChild($scope, data.id, $scope.selectData, data.level, false, true, false);
                            }
                        });
                    }
                };
