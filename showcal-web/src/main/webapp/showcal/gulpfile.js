...
var copyCssImagesFiles=[
    ...
    "./spm_modules/xn-style-common/"+xnStyleCommonVersion+"/images/*",
     "./spm_modules/xn-markdown-setting/" + xnMarkDownSetting + "/style/images/**/*"
];
...
// 定义develop任务在日常开发中使用
gulp.task("dev",["build-base-js","build-global-js","build-markdownsetting-js","build-local-js","build-global-css","build-local-less","build-print-less","copy-css-images","copy-font","copy-xn-icon","copy-cookies-map"],function(){
    console.log("运行完成dev");
});
