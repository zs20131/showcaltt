...
public class TestUserInfoRecord {
    ...
    @Before
    public void before() {
        client = new DefaultXiniuClient("http://127.0.0.1/open/router", "0617CA8376F9901F28FF46B69BF9CF47", "28570C9D069ED51226DD9F028BD5E6DC");
    }
    @Test
    public void logi223n(){
        VerificationCodeCreateRequest verificationCodeCreateRequest = new VerificationCodeCreateRequest();
        verificationCodeCreateRequest.setUserId(66l);
        verificationCodeCreateRequest.setObject("15190251170");
        VerificationCodeCreateResponse verificationCodeCreateResponse = client.execute(verificationCodeCreateRequest,"659711187734630400");
        System.out.println(verificationCodeCreateResponse.getBody());
    }
    @Test
    ...
    public void login(){
        ...
        loginRequest.setPassword(EncryptUtil.MD5("123456"));
